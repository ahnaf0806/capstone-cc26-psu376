...
function PageContent({
  ...
  const coffeeType = result.input?.coffeeType || "Unknown";
  const coffeeInfo = COFFEE_INFO[coffeeType];
  ...
  const detectedSources = coffeeInfo
    ? [
        {
          ...
          detail: `${coffeeInfo.range} per cangkir`,
          total: `${caffeineFromInput} mg total`,
    ...
    : [
        {
          label: coffeeType,
          detail: "Jenis kopi dari input pengguna",
          total: `${caffeineFromInput} mg total`,
          color: "#553722",
          bg: "rgba(85,55,34,0.1)",
          border: "rgba(85,55,34,0.2)",
